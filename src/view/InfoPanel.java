...
public class InfoPanel extends JPanel {
    ...
    public InfoPanel(String nomJoueur1, String nomJoueur2, PlateauDeJeu plateau) {
        ...
        infosPanel.setBorder(BorderFactory.createTitledBorder(
                BorderFactory.createLineBorder(borderGold), "Unité sélectionnée"));
    ...
    public void majInfos(Unite u) {
        if (u == null) {
            ...
            defenseLabel.setText("Bonus défense : -");
        } else {
            ...
            if (hex != null) {
                ...
                defenseLabel.setText("Bonus défense : " + terrain.getBonusDefense() + "%");
            } else {
                terrainLabel.setText("Terrain : ?");
                defenseLabel.setText("Bonus défense : ?");
            }
